                            ...
                            <div class="graph-sets">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-white btn-sm dropdown-toggle" type="button"
                                        ...
                                        2022 <img src="{{asset('')}}backend/img/icons/dropdown.svg" alt="img" class="ms-2">
                                    </button>
                            ...
                            <div class="table-responsive dataview">
                                <table class="table datatable ">
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="productlist.html" class="product-img">
                                                <img src="{{asset('')}}backend/img/product/product22.jpg" alt="product">
                                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="productlist.html" class="product-img">
                                                <img src="{{asset('')}}backend/img/product/product23.jpg" alt="product">
                                            </a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="productimgname">
                                            <a href="productlist.html" class="product-img">
                                                <img src="{{asset('')}}backend/img/product/product24.jpg" alt="product">
                                            </a>
